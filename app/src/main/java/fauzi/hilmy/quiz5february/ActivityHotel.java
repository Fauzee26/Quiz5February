...
public class ActivityHotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[][] data = new String[][]{{"greenland", "GREENLAND HOTEL BATAM CENTER", "Komp. Ruko Greenland, Blok J, No. 10 – 16, Batam Center", "Koneksi internet gratis di setiap ruangan, spa, massage, BBQ, restoran, lounge, dan conference room.", "Rp 194.458* per malam."},
        ...
        lvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent a1 = new Intent(ActivityHotel.this, ActivityDetail.class);
                a1.putExtra("gambara", data[i][0]);
